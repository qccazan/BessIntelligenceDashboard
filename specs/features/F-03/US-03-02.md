...
|----|-----|-----------|------|
| TC-03-02-01 | AC-1 | Verify each row displays exactly one State badge with one of four values: Charging, Discharging, Idle, or Fault | E2E |
| TC-03-02-02 | AC-2 | Verify Charging badges are teal, Discharging badges are coral, Idle badges are muted grey/purple, and Fault badges are pink | E2E |
...
| TC-03-02-05 | AC-5 | Verify the State badge colour and the sign of the Power value are mutually consistent for every row | E2E |
