...
| TC-03-05-03 | AC-3 | Verify changing the page size updates visible rows immediately without page reload | E2E |
| TC-03-05-04 | AC-4 | Verify the "Showing X–Y of Z assets" counter updates correctly | E2E |
...
| TC-03-05-07 | AC-7 | Verify ellipsis truncation when more than 7 pages exist | E2E |
