...
**As a** operator managing a multi-site portfolio, **I want to** see all my battery assets listed in a single table with their core operational metrics, **so that** I can assess the health and status of the whole fleet at a glance.
...
| TC-03-01-02 | AC-2 | Verify each row displays Asset ID, site name, State badge, Power, SoC, SoH, Temperature, and Next Action | E2E |
