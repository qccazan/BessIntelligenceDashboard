...
**As a** operator monitoring real-time operations, **I want to** see the net real-time power flow of the entire portfolio in kW, **so that** I can confirm whether the fleet is net charging, net discharging, or balanced.
...
| TC-02-03-04 | AC-4 | Verify the chip value sign is consistent with the fleet's dominant operational mode | E2E |
