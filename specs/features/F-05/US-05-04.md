...
|----|-----|-----------|------|
| TC-05-04-01 | AC-1 | Verify an operational state pill is visible in the replay card header | E2E |
| TC-05-04-02 | AC-2 | Verify the pill displays "Charging" in teal when power is positive | E2E |
| TC-05-04-03 | AC-3 | Verify the pill displays "Discharging" in coral when power is negative | E2E |
| TC-05-04-04 | AC-4 | Verify the pill displays "Idle" in muted colour when power is near zero | E2E |
| TC-05-04-05 | AC-5 | Verify the pill updates immediately when the playhead moves by animation or scrubbing | E2E |
