...
|----|-----|-----------|------|
| TC-05-01-01 | AC-1 | Verify an SVG ring gauge is rendered in the Current State card | E2E |
| TC-05-01-02 | AC-2 | Verify the ring arc length is proportional to the SoC percentage | E2E |
| TC-05-01-03 | AC-3 | Verify the numeric SoC value is displayed in the centre of the ring | E2E |
| TC-05-01-04 | AC-4 | Verify the displayed SoC percentage matches the value in the Fleet Overview table for the same asset | E2E |
| TC-05-01-05 | AC-5 | Verify the gauge updates when a different asset is selected | E2E |
