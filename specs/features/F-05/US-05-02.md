...
|----|-----|-----------|------|
| TC-05-02-01 | AC-1 | Verify a Play button is visible below the chart | E2E |
| TC-05-02-02 | AC-2 | Verify pressing Play starts the playhead animation advancing from left to right | E2E |
| TC-05-02-03 | AC-3 | Verify the timestamp readout updates at each step | E2E |
| TC-05-02-04 | AC-4 | Verify the SoC and Power values in the readout update at each step | E2E |
| TC-05-02-05 | AC-5 | Verify bars to the left of the playhead are full opacity and bars to the right are dimmed | E2E |
| TC-05-02-06 | AC-6 | Verify the Play button toggles to a Pause icon while animating | E2E |
| TC-05-02-07 | AC-7 | Verify pressing Pause halts the animation at the current position | E2E |
| TC-05-02-08 | AC-8 | Verify the animation stops automatically when the playhead reaches the last data point | E2E |
