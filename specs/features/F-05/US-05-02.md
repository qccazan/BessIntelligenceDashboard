...
|----|-----|-----------|------|
| TC-05-02-01 | AC-1 | Verify an operational state pill is displayed with one of four values: Charging, Discharging, Idle, or Fault | E2E |
| TC-05-02-02 | AC-2 | Verify the state pill colour is consistent with the Fleet Overview table colour scheme | E2E |
| TC-05-02-03 | AC-3 | Verify the real-time power value is displayed with a unit (kW) and a directional label | E2E |
| TC-05-02-04 | AC-4 | Verify charging assets show positive kW, discharging show negative kW, and idle show ~0 kW | E2E |
| TC-05-02-05 | AC-5 | Verify the state pill and power sign are mutually consistent for every selectable asset | E2E |
