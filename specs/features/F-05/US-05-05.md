...
|----|-----|-----------|------|
| TC-05-05-01 | AC-1 | Verify three summary chips (Charged, Discharged, Net Cycles) are visible below the scrub bar | E2E |
| TC-05-05-02 | AC-2 | Verify all three chips display non-zero, non-empty values for every selectable asset | E2E |
| TC-05-05-03 | AC-3 | Verify the Charged value equals the sum of positive-power intervals × 0.25 h in kWh | E2E |
| TC-05-05-04 | AC-4 | Verify the Discharged value equals the sum of absolute negative-power intervals × 0.25 h in kWh | E2E |
| TC-05-05-05 | AC-5 | Verify the Net Cycles value equals (Charged + Discharged) ÷ 2 ÷ asset capacity, rounded to one decimal | E2E |
| TC-05-05-06 | AC-6 | Verify all three values update when a different asset is selected | E2E |
