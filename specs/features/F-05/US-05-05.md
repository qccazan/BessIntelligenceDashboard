...
|----|-----|-----------|------|
| TC-05-05-01 | AC-1 | Verify clicking a different fleet table row updates all Current State card fields without page reload | E2E |
| TC-05-05-02 | AC-2 | Verify clicking a per-battery action strip tile also updates the Current State card | E2E |
| TC-05-05-03 | AC-3 | Verify all fields update simultaneously with no stale data from the previous selection | E2E |
| TC-05-05-04 | AC-4 | Verify the asset name and site in the card banner match the newly selected row | E2E |
| TC-05-05-05 | AC-5 | Verify the transition is immediate with no visible loading delay | E2E |
