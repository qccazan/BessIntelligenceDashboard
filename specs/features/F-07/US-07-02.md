...
**As a** operator reading the price forecast, **I want to** see visually annotated windows on the chart marking when to charge and when to discharge, **so that** I can relate the AI recommendation to the price curve at a glance.
...
|----|-----|-----------|------|
| TC-07-02-01 | AC-1 | Verify a hatched teal zone is overlaid in the low-price window | E2E |
| TC-07-02-02 | AC-2 | Verify a hatched coral zone is overlaid in the high-price window | E2E |
| TC-07-02-03 | AC-3 | Verify the zones are labelled "CHARGE" and "DISCHARGE" | E2E |
| TC-07-02-04 | AC-4 | Verify a teal dot marks the minimum and a coral dot marks the maximum price | E2E |
| TC-07-02-05 | AC-5 | Verify zone alignment with price trough and peak | E2E |
