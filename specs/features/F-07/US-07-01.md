...
|----|-----|-----------|------|
| TC-07-01-01 | AC-1 | Verify the chart renders a continuous price curve spanning 24 hours | E2E |
| TC-07-01-02 | AC-2 | Verify a time axis is present with at least 5 labelled time ticks | E2E |
| TC-07-01-03 | AC-3 | Verify a price axis is present with at least 2 labelled price levels | E2E |
| TC-07-01-04 | AC-4 | Verify horizontal reference grid lines are present at each labelled price level | E2E |
| TC-07-01-05 | AC-5 | Verify the area beneath the price curve is shaded with a gradient fill | E2E |
| TC-07-01-06 | AC-6 | Verify the chart renders without visible jank or artefacts | E2E |
